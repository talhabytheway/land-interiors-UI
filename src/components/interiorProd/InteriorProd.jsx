...
const InteriorProd = () => {
  return (
    <div
      id="Studio"
      className="flex flex-col gap-10 vl:max-w-[1920px] xl:mx-auto"
    >
      ...
      <div className=" grid xl:grid-cols-10 max-md:grid-cols-5 grid-rows-2 gap-2 xl:gap-4 max-h-[70vh] px-6 sm:px-10 md:px-16 ms:px-[148px] xl:px-0 w-full xl:w-[80.333%] mx-auto [&>img]:w-full [&>img]:h-full [&>img]:object-cover">
      ...
      <div className="text-[18px] md:text-[24px] text-left xl:text-[18px] pb-3 ms:pb-10 xl:pb-3 px-6 sm:px-10 md:px-16 ms:px-[148px] xl:px-0 mx-auto xl:max-w-[600px] xl:text-center">
