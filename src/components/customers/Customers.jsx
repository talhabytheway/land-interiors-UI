...
const Customers = () => {
  ...
  return (
    <>
      <div className="mt-20 ms:mt-[114px] vl:mt-36 flex flex-col gap-[27px] vl:gap-12 vl:max-w-[1920px] xl:mx-auto customers">
        <h2 className="px-6 sm:px-10 md:px-16 ms:px-[148px] xl:px-0 text-purpD font-medium text-[20px] sm:text-[24px] md:text-[30px] lg:text-[36px] text-left xl:text-center">
          Our Happy Costumers
        </h2>

        <div className="px-6 sm:px-10 md:px-16 ms:px-[148px] xl:px-0 text-[18px] xxl:p-0 mx-auto xl:max-w-[755px] xl:text-center">
      ...
      <div className="flex flex-col gap-10 vl:max-w-[1920px] xl:mx-auto customers">
        <Carousel
          className="relative px-[1rem] md:px-[2rem] lg:p-0"
          itemPadding={width >= 1440 ? [0, 0, 100] : [40, 0]}
          itemsToShow={1}
          showArrows={true}
          ...
          >
            <div className="xl:max-w-[1200px] vl:max-w-none">
              <img
                src={carousel2}
                alt=""
                className={`h-[300px] md:h-[378px] vl:max-h-none min-h-[100%] object-cover !w-[80vw] max-w-[798px] xl:max-w-[920px] ml:max-w-[1080px] vl:max-w-[1228px] ${
              ...
              <div className=" xl:mb-0 w-full mx-auto lg:w-[650px] xl:w-[800px]">
                <div className="absolute left-0 bottom-16 md:bottom-0 xl:bottom-[-5%] vl:bottom-[-20%] ">
                  <div className="w-full mx-auto ">
                    <div className="relative z-100 bg-white w-[90%] sm:w-[90%] xl:w-[70%] vl:w-[60%] mx-auto xl:drop-shadow-2xl md:mb-7 xl:mb-24">
          ...
          >
            <div className="xl:max-w-[1200px] vl:max-w-none">
              <img
                src={carousel1}
                alt=""
                className={`h-[300px] md:h-[378px] vl:max-h-none min-h-[100%] object-cover !w-[80vw] max-w-[798px] ms:w-[920px] xl:max-w-[1024px] xxl:max-w-[1080px] vl:max-w-[1228px] ${
